...
*/	
	...
	if (file_exists($file)) { include $file; } else {	echo "Le fichier connexion est introuvable.";	}		
...
<style>
/* Optionnel : Personnaliser la barre de défilement pour les vignettes */
.card-body::-webkit-scrollbar {
    width: 6px;
}
.card-body::-webkit-scrollbar-thumb {
    background-color: #dbdfe9; /* Couleur Saul */
    border-radius: 10px;
}
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				<div class="app-header d-flex flex-column flex-stack" id="kt_app_header">
					<div class="d-flex align-items-center flex-stack flex-grow-1">
						<?php 
							...
							if (file_exists($file)) { include $file; } else {	echo "Le fichier logo est introuvable.";	}										
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<?php 
						...
						if (file_exists($file)) { include $file; } else {	echo "Le fichier sidebar est introuvable.";	}						
					?>
							...
							<div id="kt_app_content" class="app-content  flex-column-fluid ">
								...
								?>
									...
									<div class="card-toolbar d-flex gap-2 mb-5">
										<a id="exportPNG" class="btn btn-sm btn-light-primary"><img src="img/shortcuts/slider-01.png" alt=""> Ecran 1</a>
										<a id="exportPDF" class="btn btn-sm btn-light-primary"><img src="img/shortcuts/slider-01.png" alt=""> Ecran 1</a>
										<a id="exportCSV" class="btn btn-sm btn-light-primary"><img src="img/shortcuts/slider-01.png" alt=""> Ecran 1</a>
										<a id="addColorBtn" class="btn btn-light-success"><img src="img/shortcuts/slider-01.png" alt=""> Ecran 1</a>
